...
export const store = createStore({
  ...
  mutations: {
    ...
    REMOVE_BIKE(state, selectedBikeId) {
      state.bikes = state.bikes.filter((bike) => bike.id !== selectedBikeId); // bike represents each bike in bikes array. New bikes array without deleted bike.
  ...
  actions: {
    ...
    checkForMaintenance({ state, commit }) {
      ...
      state.bikes.forEach((bike, bikeIndex) => {
