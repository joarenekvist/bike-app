  ...
  methods: {
    ...
    recordMaintenance({ bikeId, componentIndex, maintenanceRecord, healthPercentage }) {
      ...
      if (healthDifference <= 0) {
        ...
        // Still record the maintenance even if no health improvement
      ...
      // Round mileage to 2 decimal places
      updatedComponent.health.mileage = parseFloat(updatedComponent.health.mileage.toFixed(2));
