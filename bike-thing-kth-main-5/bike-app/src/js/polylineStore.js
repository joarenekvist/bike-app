    ...
    addRouteLine(coords, state){
        ...
        try{
            ...
            const startMarker = new google.maps.Marker({
                ...
                map: state.map,
                icon: {
                    url: "https://cdn.jsdelivr.net/npm/@mdi/svg/svg/language-go.svg", // MDI flag icon as SVG
            ...
            const endMarker = new google.maps.Marker({
                ...
                map: state.map,
                icon: {
                    url: "https://cdn.jsdelivr.net/npm/@mdi/svg/svg/flag-checkered.svg", // MDI flag icon as SVG
                    scaledSize: new google.maps.Size(32, 32), // resize if needed
                  },
            });
