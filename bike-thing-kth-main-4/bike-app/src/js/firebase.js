    ...
    (docSnapshot) => {
      if (docSnapshot.exists()) {
        ...
        if (rowData.coordinates) {
          ...
          console.log("retrieved new coordinate row from ", deviceNameInDB, " with data: ", rowData.coordinates);

          //converts GNSS data to objects of type {lat: ..., lng: ....}
          const convertedCoordinates = convertCoordinates(rowData.coordinates);
          ...
          if(isInitialSnapshot){
            isInitialSnapshot = false;
              ...
              state.cachedRoutes.push({coords: convertedCoordinates, distance: distanceCovered, startTime: rowData.startTime || "00:00", endTime: rowData.endTime || "00:00"});//add the new route
