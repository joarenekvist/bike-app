...
<template> <!--The template marker denotes the html content of our .vue component. all the html code that you see on the page goes in this section.-->
    ...
    <div class="exampleNameUsedForStyling">
        <button @click="someMethodToReactToInteractionFromUser">Button text</button>   <!--the @click says that upon being clicked, call this method name-->
    </div>
    </v-app>
</template> 
...
<script>
  ...
  export default {
    name: 'ExamplePage', //every component needs a unique name
    ...
    methods: {
    someMethodToReactToInteractionFromUser() {
        try {
...
/*here's an incomplete example of how we can style the div we defined in the template above*/
  .exampleNameUsedForStyling{
      margin-bottom: 150px;  /*add some space at the top. also accepts margin-top, margin-left, margin-right, etc.*/
      font-family: 'Segoe UI', sans-serif; /*apply a font*/
      font-weight: 600;  /*slightly bolds the font*/
      font-size: 2.9rem;  /*adjusts font size for the text*/
