...
<template>
    <div>
      <ExamplePage :someProp= "getSomeProp" @some-event-name="handleThisEvent"/>
    </div>
</template>
...
<script>
  ...
  export default {
    name: "ExamplePagePresenter",   //needs a unique name
    components: {
      ExamplePage,   //needs to declare the custom component (view) contained within.
    },
