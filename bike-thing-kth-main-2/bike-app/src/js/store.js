...
import {addUserToDatabase, subscribeToUserInDatabase, updateBikePartInformationInDatabase, updateUserSettingsInDatabase} from '@/js/firebase.js';
    ...
    actions: {
        ...
        logout({ commit }) {
          ...
          checkForMaintenance({state, commit}) {
            ...
            state.bikeComponents.forEach((component, index) => {
            ...
            commit("SET_MAINTENANCE_COMPONENTS", []);
            
            // Add each component that needs maintenance
            maintenanceNeeded.forEach(component => {
              commit("ADD_MAINTENANCECOMPONENT", component);
            });
